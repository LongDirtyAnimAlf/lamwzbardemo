...
zipalign -v -p 4 C:\fpclazbydeluxe\newembedded\projects\LAMWProjects\zbardemo\build\outputs\apk\release\zbardemo-universal-release-unsigned.apk C:\fpclazbydeluxe\newembedded\projects\LAMWProjects\zbardemo\build\outputs\apk\release\zbardemo-universal-release-unsigned-aligned.apk
